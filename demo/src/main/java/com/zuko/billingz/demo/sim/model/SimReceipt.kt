...
/**
 * In-memory [Receiptz] representing a completed transaction (the "owned" record).
 */
class SimReceipt(
    private val storeType: StoreType,
    override var entitlement: String?,
    override var orderId: String?,
    override var userId: String?,
    override var skus: List<String>?,
    override var orderDate: Date?,
