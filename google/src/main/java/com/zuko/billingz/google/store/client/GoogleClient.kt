...
class GoogleClient(private val purchasesUpdatedListener: PurchasesUpdatedListener): Client {
    ...
    private var connectionListener: Client.ConnectionListener? = null
    ...
    override fun init(
        context: Context?,
        connectionListener: Client.ConnectionListener
    ) {
